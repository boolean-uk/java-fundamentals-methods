...
public class Extension extends ExtensionBase {
     ...
     */
        public int remainingBakeTime(int minIn) {
     ...
     */
        public int calculatePrepTime(int cakeLayers) {
            return cakeLayers*3;
        }
     ...
     */
        public int totalTimeSpent(int cakeLayers, int minIn) {
            return bakingTime()-remainingBakeTime(minIn)+calculatePrepTime(cakeLayers);
        }
