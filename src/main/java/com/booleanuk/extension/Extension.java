...
public class Extension extends ExtensionBase {
     ...
     */
        public int remainingBakeTime(int numMinutes) {
            return bakingTime() - numMinutes;
        }
     ...
     */
    public int totalTimeSpent(int numLayers, int numMinutes) {
        return calculatePrepTime(numLayers) + numMinutes;
    }
