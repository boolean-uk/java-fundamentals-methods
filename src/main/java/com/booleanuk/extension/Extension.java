...
public class Extension extends ExtensionBase {
    ...
    public int remainingBakeTime(int minutesInTheOven) {
    ...
    public int calculatePrepTime(int numberOfCakeLayers) {
    ...
    public int totalTimeSpent(int numberOfCakeLayers, int minutesInTheOven) {
        return calculatePrepTime(numberOfCakeLayers) + minutesInTheOven;
    }
