...
public class Extension extends ExtensionBase {
    ...
    public int remainingBakeTime(int minutesBaked){ return bakingTime() - minutesBaked; }
    ...
    public int totalTimeSpent(int layers, int minutesBaked){
        return minutesBaked + calculatePrepTime(layers);
    }
