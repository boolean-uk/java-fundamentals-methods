...
public class Extension extends ExtensionBase {
     ...
     */
    public int remainingBakeTime(int passedTime) {
        return bakingTime() -passedTime;
    }
     ...
     */
    public int totalTimeSpent(int layers,int passedTime) {
        return calculatePrepTime(layers) + passedTime;
    }
