...
public class Extension extends ExtensionBase {
    ...
    public int remainingBakeTime(int noOfMinutesInOven) {
        return bakingTime() - noOfMinutesInOven;
    }
    ...
    public int calculatePrepTime(int noOfLayers) {
        return 3 * noOfLayers;
    }
    ...
    public int totalTimeSpent(int noOfLayers, int noOfMinutesInOven) {
        return calculatePrepTime(noOfLayers) + noOfMinutesInOven;
    }
