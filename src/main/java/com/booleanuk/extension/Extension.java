...
public class Extension extends ExtensionBase {
     ...
     */
    public int remainingBakeTime(int bakeTime){
        int timeLeft = bakingTime() - bakeTime;
        return timeLeft;
    }
     ...
     */
    public int totalTimeSpent(int layers, int bakingTime){
        Extension baking = new Extension();
        int timeSpent = calculatePrepTime(layers) + bakingTime;
