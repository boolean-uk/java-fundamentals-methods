...
public class Extension extends ExtensionBase {
     ...
     */
    public int totalTimeSpent(int numberOfLayers, int minutesInOver){
        int prepTime = calculatePrepTime(numberOfLayers);
        int totalTime = prepTime + minutesInOver;
        return totalTime;
    }
