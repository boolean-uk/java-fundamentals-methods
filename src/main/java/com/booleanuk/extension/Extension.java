...
public class Extension extends ExtensionBase {
     ...
     */
        public int remainingBakeTime(int minutesInTheOven){return bakingTime()-minutesInTheOven;}
     ...
     */
    public int totalTimeSpent(int numberOfLayers, int minutesInTheOven){
        return calculatePrepTime(numberOfLayers) + minutesInTheOven;
    }
