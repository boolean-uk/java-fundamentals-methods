...
public class Exercise extends ExerciseBase {
    ...
    public int[] constructNumberArray (int lower, int upper){
        ...
        int[] arrayOfNumbers =new int[upper-lower+1];

        for(int i=0; i<=upper-lower; i++){


            arrayOfNumbers[i] = lower + i;
        }
    ...
    public String shout (String str, int numberOfExclamations){
        str = str.toUpperCase();
        str += "!".repeat(numberOfExclamations);
