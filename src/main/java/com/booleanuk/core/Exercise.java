...
public class Exercise extends ExerciseBase {
    ...
    /*
        ...
        Edward | Hi, Edward :)
     */
    public String happilyGreet(String name) { return "Hi, " + name + " :)";
    }
    ...
    /*
        ...
        error, 10   | ERROR!!!!!!!!!!
     */
    public String shout(String input, int numberOfExclamationMarks) {

        String shouted = input.toUpperCase();
        shouted += "!".repeat(Math.max(0, numberOfExclamationMarks));
